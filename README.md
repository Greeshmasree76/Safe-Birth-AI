...
SafeBirth AI is a deployed full-stack healthcare prototype for C-section risk prediction and Modified Robson Criteria based audit analytics. The system allows hospital staff to enter patient data, classify patients into Robson groups, predict delivery risk, monitor high-risk cases, generate reports, and analyze group-wise C-section trends.

> This project is a clinical decision-support prototype and is not a replacement for qualified medical judgment.
...
- **GitHub Repo:** https://github.com/Greeshmasree76/RiskPrediction
...
| Role | Email | Password |
|---|---|---|
| Admin | admin@safebirth.ai | admin123 |
| Doctor | doctor@safebirth.ai | doctor123 |
| Nurse / Staff | nurse@safebirth.ai | nurse123 |
| Data Analyst | analyst@safebirth.ai | analyst123 |
